...
public class KillButton extends ActionButton {
	
	public KillButton(Handler handler) {
		super(handler);
	...
	public void processButtonPress() {		
		handler.getGameState().setCurrAction(Actions.Kill);
	...
	public void setupTexture() {
		texture = handler.getAssets().getRoles().get("hitman")[3][0];
		selectedImg = handler.getAssets().getRoles().get("hitman")[3][1];
		disabledImg = handler.getAssets().getRoles().get("hitman")[3][2];
	}
