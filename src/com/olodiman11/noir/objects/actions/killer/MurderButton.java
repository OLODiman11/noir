...
public class MurderButton extends ActionButton {
	
	public MurderButton(Handler handler) {
		super(handler);
	...
	public void processButtonPress() {
		handler.getGameState().setCurrAction(Actions.Murder);
	...
	public void setupTexture() {
		texture = handler.getAssets().getRoles().get("killer")[2][0];
		selectedImg = handler.getAssets().getRoles().get("killer")[2][1];
		disabledImg = handler.getAssets().getRoles().get("killer")[2][2];
	}
