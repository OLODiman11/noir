...
public class Packet63OfSwap extends Packet{

	private int[][] coords;
	
	public Packet63OfSwap(String username, int[][] coords) {
		super(63);
		this.username = username;
		this.coords = coords;
	}
	
	public Packet63OfSwap(byte[] data) {
		super(63);
	...
	public byte[] getData() {
		...
		return ("63" + username + ";" + data + "~/~").getBytes();
	}
